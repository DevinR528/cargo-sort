...
macro_rules! t(
    ($name:ident, $msg:expr, $toml:expr) => (
        #[test]
        fn $name() {
            run(include_str!(concat!("../../../", $toml)), $msg);
        }
    )
);
...
t!(test_datetime_malformed_no_t, "", "fixtures/invalid/datetime-malformed-no-t.toml");
t!(
    test_datetime_malformed_with_milli,
    "While parsing a Date-Time",
    "fixtures/invalid/datetime-malformed-with-milli.toml"
);
t!(test_duplicate_keys, "Duplicate key", "fixtures/invalid/duplicate-keys.toml");
t!(
    test_duplicate_key_table,
    "Duplicate key",
    "fixtures/invalid/duplicate-key-table.toml"
);
t!(test_duplicate_tables, "Duplicate key", "fixtures/invalid/duplicate-tables.toml");
t!(
    test_empty_implicit_table,
    "While parsing a Table Header",
    "fixtures/invalid/empty-implicit-table.toml"
);
t!(test_empty_table, "While parsing a Table Header", "fixtures/invalid/empty-table.toml");
t!(
...
t!(test_float_leading_zero, "Unexpected `3`", "fixtures/invalid/float-leading-zero.toml");
t!(
...
t!(test_integer_leading_zero_neg, "", "fixtures/invalid/integer-leading-zero-neg.toml");
t!(test_integer_leading_zero_pos, "", "fixtures/invalid/integer-leading-zero-pos.toml");
t!(test_integer_leading_zero, "", "fixtures/invalid/integer-leading-zero.toml");
t!(test_integer_underscore_after, "", "fixtures/invalid/integer-underscore-after.toml");
t!(test_integer_underscore_before, "", "fixtures/invalid/integer-underscore-before.toml");
t!(test_integer_underscore_double, "", "fixtures/invalid/integer-underscore-double.toml");
t!(test_integer_invalid_hex_char, "", "fixtures/invalid/integer-invalid-hex-char.toml");
t!(
...
t!(test_key_after_array, "", "fixtures/invalid/key-after-array.toml");
t!(test_key_after_table, "", "fixtures/invalid/key-after-table.toml");
...
t!(test_key_open_bracket, "", "fixtures/invalid/key-open-bracket.toml");
t!(test_key_single_open_bracket, "", "fixtures/invalid/key-single-open-bracket.toml");
t!(test_key_space, "", "fixtures/invalid/key-space.toml");
t!(test_key_start_bracket, "", "fixtures/invalid/key-start-bracket.toml");
t!(test_key_two_equals, "", "fixtures/invalid/key-two-equals.toml");
t!(test_llbrace, "", "fixtures/invalid/llbrace.toml");
t!(test_rrbrace, "", "fixtures/invalid/rrbrace.toml");
t!(test_string_bad_byte_escape, "", "fixtures/invalid/string-bad-byte-escape.toml");
t!(test_string_bad_escape, "", "fixtures/invalid/string-bad-escape.toml");
t!(test_string_bad_surrogate, "", "fixtures/invalid/string-bad-surrogate.toml");
t!(test_string_bad_uni_esc, "", "fixtures/invalid/string-bad-uni-esc.toml");
t!(test_string_byte_escapes, "", "fixtures/invalid/string-byte-escapes.toml");
t!(test_string_no_close, "", "fixtures/invalid/string-no-close.toml");
t!(test_table_array_implicit, "", "fixtures/invalid/table-array-implicit.toml");
t!(
...
t!(test_table_whitespace, "", "fixtures/invalid/table-whitespace.toml");
t!(test_table_with_pound, "", "fixtures/invalid/table-with-pound.toml");
t!(test_text_after_array_entries, "", "fixtures/invalid/text-after-array-entries.toml");
t!(test_text_after_integer, "", "fixtures/invalid/text-after-integer.toml");
t!(test_text_after_string, "", "fixtures/invalid/text-after-string.toml");
t!(test_text_after_table, "", "fixtures/invalid/text-after-table.toml");
t!(
    test_text_before_array_separator,
    "",
    "fixtures/invalid/text-before-array-separator.toml"
);
t!(test_text_in_array, "", "fixtures/invalid/text-in-array.toml");
