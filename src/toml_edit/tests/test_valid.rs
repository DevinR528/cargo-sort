...
fn pair_to_json((key, value): (&str, Item)) -> (String, Json) {
    ...
    fn value_to_json(value: &Value) -> Json {
        match value {
            ...
            Value::Integer(i) => {
                typed_json("integer", Json::String(format!("{}", i.value())))
            }
            Value::Float(f) => {
                typed_json("float", Json::String(format!("{}", f.value())))
            }
...
macro_rules! t(
    ($name:ident, $json:expr, $toml:expr) => (
        ...
        fn $name() {
            run(
                include_str!(concat!("../../../", $json)),
                include_str!(concat!("../../../", $toml))
            )
        }
    )
);
...
t!(test_arrays, "fixtures/valid/arrays.json", "fixtures/valid/arrays.toml");
t!(
    test_arrays_nested,
    "fixtures/valid/arrays-nested.json",
    "fixtures/valid/arrays-nested.toml"
);
t!(test_bool, "fixtures/valid/bool.json", "fixtures/valid/bool.toml");
t!(
...
t!(test_datetime, "fixtures/valid/datetime.json", "fixtures/valid/datetime.toml");
t!(test_empty, "fixtures/valid/empty.json", "fixtures/valid/empty.toml");
t!(test_example, "fixtures/valid/example.json", "fixtures/valid/example.toml");
t!(
    test_float_exponent,
    "fixtures/valid/float-exponent.json",
    "fixtures/valid/float-exponent.toml"
);
t!(test_float, "fixtures/valid/float.json", "fixtures/valid/float.toml");
t!(
...
t!(test_integer, "fixtures/valid/integer.json", "fixtures/valid/integer.toml");
t!(
...
t!(test_key_space, "fixtures/valid/key-space.json", "fixtures/valid/key-space.toml");
t!(
    test_key_special_chars,
    "fixtures/valid/key-special-chars.json",
    "fixtures/valid/key-special-chars.toml"
);
t!(test_long_float, "fixtures/valid/long-float.json", "fixtures/valid/long-float.toml");
t!(
    test_long_integer,
...
t!(test_raw_string, "fixtures/valid/raw-string.json", "fixtures/valid/raw-string.toml");
t!(
    test_string_empty,
...
t!(test_string_nl, "fixtures/valid/string-nl.json", "fixtures/valid/string-nl.toml");
t!(
    test_string_simple,
